...
### 📖 About Me
Dedicated Computer Science undergraduate at the **University of Westminster (IIT)**. 
I apply a user-first mindset to build impactful digital products, specializing in **Frontend Development** and **UI/UX Design**.
With experience as a **Netball Captain** and **Senior Prefect**, I bring strong leadership and teamwork to every project.
...
| :--- | :--- | :--- |
| **ArchionLabs** | AI-driven 2D to 3D architectural platform. | Next.js, Three.js, Python |
| **Spacely Estate** | High-performance responsive property search web app. | React.js, JavaScript, CSS3 |
| **Urban Bikes** | Eco-friendly traffic management prototype. | Figma |
| **Farmly** | Organic produce e-commerce platform. | HTML5, CSS3, JavaScript |
...
<p align="center">
  ...
  Senior Prefect & Captain - Dharmasoka College<br>
  Multi-time National Champion - Sri Lanka Schools Netball
</p>
